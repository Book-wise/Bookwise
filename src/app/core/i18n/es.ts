export const ES: Record<string, string> = {
  ...
  'biz.logo.error': 'No se pudo subir el logo. Intentá con una imagen válida (máx 2 MB).',
  'biz.logo.hint': 'El logo aparecerá en tus recibos y comunicaciones por email.',
  'biz.negocios_hint': 'Las empresas a las que tenés acceso.',
  'biz.no_businesses': 'Todavía no tenés negocios. Creá el primero para empezar.',
  ...
  'biz.create_error': 'No se pudo crear el negocio. Verificá los datos e intentá de nuevo.',
  'biz.go_list': 'Ir a mis negocios',
  'biz.update_success': 'El negocio fue actualizado correctamente.',
  'biz.update_error': 'No se pudo actualizar el negocio. Intentá de nuevo.',
  'biz.save': 'Guardar',
  'ui.cancel': 'Cancelar',
  ...
  'profile.avatar.change_hint': 'Subí una imagen (JPG/PNG/WebP, máx 2 MB). Se genera una miniatura optimizada.',
  'profile.avatar.success': 'Tu foto fue actualizada correctamente.',
  'profile.avatar.error': 'No se pudo subir la foto. Intentá con una imagen válida (máx 2 MB).',
  'profile.avatar.crop_title': 'Ajustá tu foto',
  'profile.avatar.crop_hint': 'Mové y ajustá el encuadre. La foto se guarda como círculo.',
  'profile.avatar.crop_cancel': 'Cancelar',
  'profile.avatar.crop_confirm': 'Guardar foto',
  'profile.avatar.load_failed': 'No se pudo cargar la imagen. Probá con otro archivo.',
